...
<div class="container">
    ...
    <div class="signup-form">
        <form action="Registrazione/valutaRichiesta" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
					...
					<span class="input-group-text">
                        ...
                        <input type="text" class="form-control" name="cognome"
                               placeholder="Cognome/Cognome amministratore" required="required">
                    </div>
                </div>
            {/if}
            <div class="form-group">
            ...
            {if $mod==false}
                <div class="form-group">
                    <label class="form-check-label"><input type="checkbox" onchange="informativa(this)" name="azienda" value="azienda">
    ...
    <div class="text-center">
        ...
        <div class="text-center">
            {if $mod==false}
                ...
                link per attivare il tuo profilo.
                <br>
            ...
            {/if}
            {if $mod==true}
                Una volta completata la registrazione  il tuo profilo verrà approvato da un amministratore, il quale ti
                contatterà il prima possibile ed attiverà il tuo profilo in seguito
            {/if}
